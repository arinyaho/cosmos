...
- `python3 ~/.codex/skills/git-worktree-side-task/scripts/worktree_side_task.py create --branch BRANCH`
...
Clean up when done:
- `python3 ~/.codex/skills/git-worktree-side-task/scripts/worktree_side_task.py cleanup --branch BRANCH`

List worktrees:
- `python3 ~/.codex/skills/git-worktree-side-task/scripts/worktree_side_task.py list`
...
## Script
- Use `~/.codex/skills/git-worktree-side-task/scripts/worktree_side_task.py` for reliable creation/cleanup.
