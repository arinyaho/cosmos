...
2) Create (or reuse) a review worktree:
   ...
   ```bash
   # Example for PR 131:
   # python3 ~/.codex/skills/git-worktree-side-task/scripts/worktree_side_task.py create --branch review/131 --reuse
   python3 ~/.codex/skills/git-worktree-side-task/scripts/worktree_side_task.py create \
