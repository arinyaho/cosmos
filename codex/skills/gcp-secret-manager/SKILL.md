...
```bash
~/.codex/skills/gcp-secret-manager/scripts/migrate-to-gcp.sh my-gcp-project
```
...
### scripts/
- `~/.codex/skills/gcp-secret-manager/scripts/migrate-to-gcp.sh`
- `~/.codex/skills/gcp-secret-manager/scripts/fetch-secrets.sh`
