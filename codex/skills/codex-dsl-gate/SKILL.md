---
name: codex-dsl-gate
description: Convert unstructured natural language requests into a YAML Task Card (Codex DSL) and require explicit confirmation before executing any shell commands or file edits.
---
